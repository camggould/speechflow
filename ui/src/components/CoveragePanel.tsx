...
interface CoveragePanelProps {
  iterationId: string;
  // When embedded inside InsightsPanel, drop the standalone chrome
  // (border, fixed width, "Coverage" header) — the parent provides those.
  embedded?: boolean;
}

export function CoveragePanel({ iterationId, embedded }: CoveragePanelProps) {
